...
public class HomeViewController: UIViewController {
    ...
    private func setupCollectionView() {
        ...
        sliderCollectionView.register(UINib(nibName: "SliderCollectionViewCell", bundle: Bundle(for: SliderCollectionViewCell.self)), forCellWithReuseIdentifier: "SliderCell")
